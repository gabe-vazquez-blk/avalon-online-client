  ...
  render() {
    return (
      <div style={{ position: "absolute", right: "1vw", top: "52vh", width: "90%" }}>
        ...
        <Segment>
          <Button name='approved' color='purple' onClick={this.props.handleApproval}> Approve </Button>
          <Button name='rejected' color='black' onClick={this.props.handleApproval}> Reject  </Button>
